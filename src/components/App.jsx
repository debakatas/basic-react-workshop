...
const App = () => <>
    ...
    <figure className="square square--small">
        <img className="square__img" src="https://source.unsplash.com/random/800x700" alt="" />
    </figure>
    <figure className="square square--large">
        <img className="square__img" src="https://source.unsplash.com/random/800x700?a=1" alt="" />
    </figure>
